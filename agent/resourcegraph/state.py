...
class InputState:
    ...
    use_cases: str
    "The use cases for which the agent is tasked to gather information."

    info: Optional[dict[str, Any]] = field(default=None)
    "The info state tracks the current extracted data for the given , conforming to the provided schema. This is primarily populated by the agent."
