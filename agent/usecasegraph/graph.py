...
from agent.usecasegraph import prompts
from agent.usecasegraph.configuration import Configuration
from agent.usecasegraph.state import InputState, OutputState, State
from agent.usecasegraph.utils import init_model
...
async def call_agent_model(
    ...
    model = raw_model.bind_tools([info_tool], tool_choice="any")
...
def route_after_agent(
    state: State,
) -> Literal["reflect", "call_agent_model", "__end__"]:
...
usecasegraph = researcher_workflow.compile()
usecasegraph.name = "Usecase Graph"
