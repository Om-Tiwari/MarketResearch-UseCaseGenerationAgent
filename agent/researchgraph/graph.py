...
from agent.researchgraph import prompts
from agent.researchgraph.configuration import Configuration
from agent.researchgraph.state import InputState, OutputState, State
from agent.researchgraph.tools import scrape_website, search
...
researcher_workflow.add_node("tools", ToolNode([search, scrape_website]))
...
researchgraph.name = "Research Topic"
